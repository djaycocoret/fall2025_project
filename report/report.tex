...
\begin{equation}
z_{i, t} = x_{i, t-1} + \dfrac{r_c - d}{|i - column_{death}| + 1} * \alpha
\end{equation}
...
$d$ if the boolean value which is true iff the agent was eliminated by a tower, $column_{death}$ is the index of the column where the agent has died,
...
\begin{equation}
x_i = \dfrac{e^{z_{i, t}}}{\sum_{z \in \mathcal{Z}}^{N} e^{z_j, t}}
\end{equation}
